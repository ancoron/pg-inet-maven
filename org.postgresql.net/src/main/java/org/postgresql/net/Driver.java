...
/**
 * Driver for enhanced networking type support from PostgreSQL.
 * 
 * <p>Most of this code is borrowed from org.postgresql.Driver.
 * 
...
public class Driver implements java.sql.Driver
{
    ...
    private static Connection makeConnection(String url, Properties props) throws SQLException {
        Jdbc4Connection conn = new org.postgresql.jdbc4.Jdbc4Connection(host(props), port(props),
                                      user(props), database(props),
                                      props, url);

        // add a property for explicit auto-commit turn-off...
        if("false".equalsIgnoreCase(props.getProperty("autoCommit"))) {
            // if disabled --> disable, otherwise keep at default...
            conn.autoCommit = false;
        }

        // add data types...
        conn.addDataType("inet", org.postgresql.net.PGinet.class);
        conn.addDataType("cidr", org.postgresql.net.PGcidr.class);
        conn.addDataType("macaddr", org.postgresql.net.PGmacaddr.class);
    ...
    {
        return "PostgreSQL 9.1 JDBC4.1 (build " + PSQLDriverVersion.buildNumber + ") Networking Support";
    }
    ...
    static private String[] protocols = { "jdbc", "postgresqlnet" };
