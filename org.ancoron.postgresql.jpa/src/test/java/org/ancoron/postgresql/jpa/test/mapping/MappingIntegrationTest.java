...
public class MappingIntegrationTest {
    ...
    static {
        log = Logger.getLogger(MappingIntegrationTest.class.getName());
    }
    ...
    public void testMapping() throws Exception {
        ...
        try {
            ...
            NetworkEntity net = new NetworkEntity(new Network("10.10.0.0/16"));
            ...
            net = new NetworkEntity(new Network(((PGobject) o[1]).getValue()));
            net.setId((Long) o[0]);
